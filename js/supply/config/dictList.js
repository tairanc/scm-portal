    ...
    $.dictApp = {
        init : function(){
            ...
            var columns = [
                ...
                {title : '类型编码',dataIndex :'typeCode', visible : false},
                {title : '类型名称',dataIndex :'typeName', width:'15%',elCls : 'center'},
            ...
            var props = {
                ...
                dataUrl: $.scmServerUrl + "config/dictPage",
                ...
                handlerCollections: [
                    {
                        ...
                        redictUrl: "dictUpdate.html" //页面跳转地址, 当 operateType=1时不能为空
                    }
                ] //操作集合
            } ;
         ...
         */
        add:function(){
            window.location.href = "dictAdd.html";
        },
        /***
         * 查询启用/停用列表
         */
