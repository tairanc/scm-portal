            ...
            BUI.use(['bui/form','bui/tooltip'],function(Form, Tooltip){
                ...
                $("#name").on("blur",function(){
                    if(form.isValid()){
                        ...
                        $.checkRepat($.dictAddApp._dictQueryUrl, name, param, "该名称已经存在,请用其他名称！");
                    }
                });
                ...
                $("#value").on("blur",function(){
                    if(form.isValid()){
                        ...
                        $.checkRepat($.dictAddApp._dictQueryUrl, value, param, "该字典值已经存在,请用其他字典值！");
                    }
                });
