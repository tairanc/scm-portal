...
$(function () {
    $.resourceManage = {
        ...
        queryTreeNode: function () {
            ...
            aContent.url = $.scmServerUrl + "aclWmsUser/aclWmsTree";
        ...
        saveResourceManage: function (fromData, tip) {
            var aContent = $.AjaxContent();
            aContent.url = $.scmServerUrl + "aclWmsUser/aclWmsSave";
        ...
        updateClassify: function (fromData) {
            ...
            var aContent = $.AjaxContent();
            aContent.url = $.scmServerUrl + "aclWmsUser/aclWmsUpdate/" + fromData.id;
            aContent.data = fromData;
            aContent.type = "PUT";
            aContent.success = function (result, textStatus) {
                if (result.appcode != 1) {
