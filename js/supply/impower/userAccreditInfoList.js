 ...
 */
$(function(){
    $.userAccreditInfoListApp = {
        init : function(){
            $.userAccreditInfoListApp.queryValidList();
            var columns = [
                ...
                {title : '用户类型',dataIndex :'userType', width:'15%',elCls : 'center', renderer : function(val){
                    return '<span>'+$.dictTranslate("userType", val)+'</span>';
                }},
                {title : '角色',dataIndex :'roleNames', width:'15%',elCls : 'center'},
            ...
            BUI.use('bui/form',function(Form){
                ...
                $("#add_btn").on("click",function(){
                    $.userAccreditInfoListApp.add();
                });

                $("#role_btn").on("click",function () {
                    $.userAccreditInfoListApp.roleListPage();
                })
            });
            ...
            var props = {
                ...
                dataUrl: $.scmServerUrl + "accredit/accreditInfoPage",
                ...
                handlerCollections: [
                    {
                        ...
                        redictUrl: "userAccreditInfoUpdate.html" //页面跳转地址, 当 operateType=1时不能为空
                    },
                    {
                        name: "启用", //操作名称
                        ajaxMethod:"PUT",
                        ...
                        submitUrl: $.scmServerUrl+"accredit/accreditInfo/updateState", //提交后台地址, 当 operateType=0时不能为空
         ...
         */
        add:function(){
           window.location.href = "userAccreditInfoAdd.html";
        },
        /**
         * 查询启用/停用列表
         */
