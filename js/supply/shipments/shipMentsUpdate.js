...
$(function(){
    ...
    $.shipMentsUpdateApp = {
        ...
        init:function(){
            ...
            $.shipMentsUpdateApp.fileForm(id);
            $.shipMentsUpdateApp.queryDictTypeList();
            ...
            BUI.use(['bui/form','bui/tooltip'],function(Form, Tooltip){
                ...
                $("#save_btn").on("click",function(){
                	...
                	if(form.isValid()){
	                       $.shipMentsUpdateApp.save(formData, tip);
	                   }
                });
        ...
        fileForm:function (id) {
            ...
            aContent.success = function(result,textStatus){
                if(result.appcode != 1){
                    ...
                    $.shipMentsUpdateApp._isValid = dictDtl.isValid;
    ...
    $(document).ready(function(e) {
        $.shipMentsUpdateApp.init();
    });
    //页面完全加载完成后设置单选框默认选中
    window.onload=function(){
        $.setRadioChecked('isValid', $.shipMentsUpdateApp._isValid);
    }
}(jQuery));
