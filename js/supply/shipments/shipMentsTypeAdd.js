        ...
        init:function(){
            ...
            BUI.use(['bui/form','bui/tooltip'],function(Form, Tooltip){
                ...
                $("#save_btn").on("click",function(){
                	...
                	if(form.isValid()){
	                       $.shipMentsTypeAddApp.save(formData, tip);
	                   }
                });
                ...
                $("#code").on("blur",function(){
                    if(form.isValid()){
                        ...
                        $.checkRepat($.shipMentsTypeAddApp._dictTypeQueryUrl, code, param, "该编号已经存在,请用其他编号！");
                    }
                });
                ...
                $("#name").on("blur",function(){
                    if(form.isValid()){
                        ...
                        $.checkRepat($.shipMentsTypeAddApp._dictTypeQueryUrl, name, param, "该名称已经存在,请用其他名称！");
                    }
                });
