...
$(function () {
    ...
    $.shipMentsTypeApp = {
        init: function () {
            $.shipMentsTypeApp.queryValidList();
            var columns = [
                ...
                handlerCollections: [
                    {
                        ...
                        redictUrl: "shipMentsTypeUpdate.html" //页面跳转地址, 当 operateType=1时不能为空
                    }
                ] //操作集合
            };
         ...
         */
        add: function () {
            window.location.href = "shipMentsTypeAdd.html";
        },
        /***
         * 查询启用/停用列表
         */
