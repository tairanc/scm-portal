 ...
 */
$(function(){
    $.supplierBrandSelect2App = {
        supplierCode : "",
        brandList : "",
        init : function(){

            this.supplierCode = $("#supplierCode2").val();

            setTimeout(function () {
                $.supplierBrandSelect2App.queryBrand();
            },300)
            ...
            BUI.use(['bui/form','bui/select','bui/list'],function(Form, Select, List){
                ...
                $.supplierBrandSelect2App.brandList = new List.SimpleList({
                ...
                $.supplierBrandSelect2App.brandList.render();
            ...
            aContent.success = function(result,textStatus){
                if(result.appcode != 1){
                    ...
                    if(data.length > 0){
                        ...
                        if (items.length > 0) {
                            $.supplierBrandSelect2App.brandList.set('items', items);
                        }
                    }
