...
(function () {
    ...
    $.storehouseitemSelect = {

        warehouseInfoOutId:null,
        warehouseInfoInId:null,
        _store:null,
        init: function () {
            if(($.storehouseAddApp.skuArray)==null){
                $.storehouseAddApp.skuArray = [];
            };
            $.storehouseitemSelect.queryWarehouseTypeList();
            BUI.use(['bui/form','bui/grid','bui/data','common/pagingbarext'],function(Form,Grid,Data,PagingBarExt){
                ...
                var store = new Store({
                    url : $.scmServerUrl +"allocateOrder/skuPage?warehouseInfoInId="+$.storehouseitemSelect.warehouseInfoInId+'&warehouseInfoOutId='+$.storehouseitemSelect.warehouseInfoOutId+'&skus='+$.storehouseAddApp.skuArray.join(","),
                    autoLoad:true,
                    proxy : {
                        method : 'get',
                ...
                $.storehouseitemSelect._store = store;
                ...
                $("#select_btn_item").on("click", function () {
                    storehouseselectItemsRecord(grid.getSelection());
                });
        ...
        queryWarehouseTypeList : function () {
            var aContent = $.AjaxContent();
            //aContent.url = $.scmServerUrl+"purchase/supplierBrand/"+$.storehouseitemSelect.warehouseInfoOutId;
