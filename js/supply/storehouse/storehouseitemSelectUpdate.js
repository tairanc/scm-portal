...
(function () {
    ...
    $.storehouseitemSelectUpdate = {

        warehouseInfoOutId:null,
        warehouseInfoInId:null,
        _store:null,
        init: function () {

            $.storehouseitemSelectUpdate.queryWarehouseTypeList();
            ...
            BUI.use(['bui/form','bui/grid','bui/data','common/pagingbarext'],function(Form,Grid,Data,PagingBarExt){
                ...
                //form.render();
                var columns = [
                    {title: '商品SKU名称',width:150, dataIndex: 'skuName',elCls: 'center'},//spuCode
                    {title: '商品spuCode', dataIndex: 'spuCode',elCls: 'center', visible : false},
                    {title: '商品SKU编码',width:120, dataIndex: 'skuCode',elCls: 'center'},
                    {title: '规格',width:150, dataIndex: 'specNatureInfo',elCls: 'center'},
                    {title: '货号', dataIndex: 'skuNo',elCls: 'center'},
                    ...
                    {title: '一级分类/二级分类/三级分类',width:170,dataIndex: 'allCategoryName', elCls: 'center'},
                ...
                var store = new Store({
                    url : $.scmServerUrl +"allocateOrder/skuPage?warehouseInfoInId="+$.storehouseitemSelectUpdate.warehouseInfoInId+'&warehouseInfoOutId='+$.storehouseitemSelectUpdate.warehouseInfoOutId+'&skus='+$.storehouseUpdateApp.skuArray.join(","),
                    autoLoad:true,
                    proxy : {
                        method : 'get',
                ...
                grid.render();
                $.storehouseitemSelectUpdate._store = store;
                ...
                $("#select_btn_item_update").on("click", function () {
                    storehouseselectItemsRecordUpdate(grid.getSelection());
                });
            ...
            var props = {
                ...
                dataUrl: $.scmServerUrl + "purchase/purchaseOrderItem?skus="+$.purchaseOrderUpdateApp.skuArray+"&warehouseInfoId="+$.storehouseitemSelectUpdate.warehouseInfoId+'&warehouseInfoInId='+$.storehouseitemSelectUpdate.warehouseInfoInId,
        ...
        queryWarehouseTypeList : function () {
            var aContent = $.AjaxContent();
            //aContent.url = $.scmServerUrl+"purchase/supplierBrand/"+$.storehouseitemSelectUpdate.warehouseInfoInId;
